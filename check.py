...
def extract_year_score(text_content):
    content =  '''
                            ...
                            Dont extract dates of any certifications or anything other than the things mentioned above and arrange this list of date ranges in ascending order of the left date of date range and don't separately sort work or education dates, they should only be arranged in order of their dates. This should be in a standard format - "Month Year - Month Year(Type of date_range)".
