...
def extract_year_score(text_content):
    content =  ''' 
                            ...
                            similarly if someone has worked from Nov’17-Present, add it to the date ranges list as November 2007 - Present (work), and if someone has mentioned the dates of their degree as 5/2016-6/2020 it should be added as May 2016 - June 2020 (education),the type of date ranges can only be either "work", "internship" or "education", if a date range inside the text content ends with present, till now or today like July 2019 - today, convert words like today, till now, till today to the word present, these dates are only for example dont add them in the final list. 
                            Dont extract dates of any certifications or anything other than date ranges mentioned above and arrange this list of date ranges in order of recent dates to past dates. This should be in a standard format - "Name of the month Year - Name of the month Year (work/internship/education)" and they should be sorted in descending order of the left side date of the date ranges.
