...
def extract_year_score(text_content):
    content =  ''' 
                            ...
                            similarly if someone has worked from Nov’17-Present, add it to the date ranges list as November 2007 - Present (work), and if someone has mentioned the dates of their degrees like this "5/2016-6/2020" it should be added as "May 2016 - June 2020 (education)", all the date ranges should follow the same format - "Name of the month" "Year" "-" ("Name of the month" "Year")/"Present" "(work/internship/education)" and the type of date ranges can only be either "work", "internship" or "education". All the fields in the format are compulsory, if something is missing out of these fields dont add it to the list. If a date range inside the text content ends with present, till now or today like July 2019 - today, convert words like today, till now, till today to the word present, these dates are only for example dont add them in the final list. 
                            Don't extract dates of any certifications or anything other than the date ranges mentioned above and they should be sorted in descending order of the left side date of the date ranges in order of recent dates to past dates.
