...
def extract_year_score(text_content):
    content =  ''' 
                            This is the text extracted from the resume of a candidate - {text_content}
                            Return a JSON with two fields containing lists,the first is the list of date ranges named date_ranges that the candidate has mentioned in the resume against any work experience or education, for example, if someone has done an internship from jan 2021 - Aug 2021, send this range as January 2021 - August 2021 (internship), 
