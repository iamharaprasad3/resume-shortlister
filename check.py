...
def extract_year_score(text_content):
    content =  '''
                            ...
                            Dont extract dates of any certifications or anything other than the things mentioned above and arrange this list of date ranges in order of recent dates to past dates. This should be in a standard format - "Month Year - Month Year(Type of date_range)" and they should be sorted in descending order of the left side date of the date ranges irrespective of the fact that they are work dates or education.
