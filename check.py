...
def extract_year_score(text_content):
    ...
    If they have mentioned that they had their graduation from 2020-2024 add it to the second list as 5/2020-5/2024. If no month is mentioned in the date range automatically add the month as 5. Follow the same format for all the date ranges in the first and second list "staring month in digits/starting year in 4 digits - ending month in digits/ending year in 4 digits". Only add work date ranges and education date ranges and to differentiate between them add a "w" in brackets at the end of job work ranges.
